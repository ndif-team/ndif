...
class ObjectStoreProvider(Provider):
    ...
    def from_env(cls):
        ...
        cls.object_store_url = os.environ.get("NDIF_OBJECT_STORE_URL", "http://localhost:27018")
        cls.object_store_bucket = os.environ.get("NDIF_OBJECT_STORE_BUCKET", "ndif-results")
        cls.object_store_access_key = os.environ.get("NDIF_OBJECT_STORE_ACCESS_KEY", "minioadmin")
        cls.object_store_secret_key = os.environ.get("NDIF_OBJECT_STORE_SECRET_KEY", "minioadmin")
        cls.object_store_region = os.environ.get("NDIF_OBJECT_STORE_REGION", "us-east-1")
        cls.object_store_verify = os.environ.get("NDIF_OBJECT_STORE_VERIFY", "false").lower() == "true"
